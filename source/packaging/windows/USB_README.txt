...
1. Windows PC에서 installer\ZeroTrustDemoSetup.exe 를 실행합니다.
   ...
   설치가 진행되는 동안 같은 설치 파일을 다시 실행하지 마세요.
   PC와 USB 속도에 따라 설치는 몇 분 걸릴 수 있습니다.
2. 설치가 끝나면 바탕화면에 다음 바로가기가 생성됩니다.
   - ZeroTrust: 메인 시스템 실행
   - ZeroTrust 제어: 서버 초기화 / 서버 종료
   - ZeroTrust 토큰 기기: OTP 토큰 기기 실행 폴더 열기
3. 시연 전 초기 상태로 되돌리려면 ZeroTrust 제어를 열고 "서버 초기화"를 누릅니다.
